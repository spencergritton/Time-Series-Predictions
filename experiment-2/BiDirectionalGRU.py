...
from tensorflow.keras.layers import GRU, Dense, Bidirectional, Input, Dropout, BatchNormalization, TimeDistributed
...
# Model name
model_name = 'BiDirectionalGRU_BTC_180_30'
...
model = Sequential()
model.add( Bidirectional(GRU(INPUT_LEN, input_shape=(trainX.shape[1:]), return_sequences=False, activity_regularizer=REGULARIZATION)) )
